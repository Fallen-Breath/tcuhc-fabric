...
public class LithiumServerTickScheduler<T> extends ServerTickScheduler<T> {
    ...
    public LithiumServerTickScheduler(ServerWorld world, Predicate<T> invalidObjPredicate, Function<T, Identifier> idToName, Function<Identifier, T> nameToId, Consumer<ScheduledTick<T>> tickConsumer) {
        super(world, invalidObjPredicate, idToName, nameToId, tickConsumer);
