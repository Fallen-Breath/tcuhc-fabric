...
public class UhcGamePlayer extends Taskable {
	...
	public UhcGameTeam getTeam() {
		return team;
	}

	protected void setTeam(UhcGameTeam team) {
		this.team = team;
	}
	...
	public void setColorSelected(@Nullable UhcGameColor color) {
		colorSelected = color;
	}

	public Optional<UhcGameColor> getColorSelected() {
		return Optional.ofNullable(colorSelected);
	}
	...
	public PlayerStatistics getStat() {
		return statistics;
	}
